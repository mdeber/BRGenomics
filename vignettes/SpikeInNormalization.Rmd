...
And if we wanted to isolate the spike-in reads, there is an analagous 
...
normlized to the within-replicate negative control (see the documentation for 
further details).
...
Normalization by subsampling sacrifices information to reduce biases across 
datasets.
